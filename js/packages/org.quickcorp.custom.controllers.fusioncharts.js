'use strict';
Package('org.quickcorp.custom.controllers.fusioncharts',[
  Class('FCController',Controller,{
    _new_: function(o) {
      this.__new__(o);
      var controller = this;
      //TODO: Implement
            ...
            external:true,done:()=>{}
					...
					controller.dependencies.push(New(SourceJS,{
						...
						external:false,
							...
							global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/fusioncharts.theme.fusion.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/fusioncharts.maps.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.world.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.africa.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.asia.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.australia.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.europe.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.northamerica.js',
								external:false,
								done:function (){}
							}));
              global.set('fusionChartsLoaded',true);
							controller.dependencies.push(New(SourceJS,{
								url:'js/packages/fusioncharts/maps/fusioncharts.southamerica.js',
								external:false,
								done:function (){}
							}));
							resolve();
  ...
  Class('FCWorldMapController',FCController,{
    done: function() {
